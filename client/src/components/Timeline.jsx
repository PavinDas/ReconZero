export default function Timeline({ events }) {
  return (
    <div className="terminal-panel max-h-[340px] overflow-hidden p-4">
      <div className="mb-3 text-xs uppercase tracking-[0.2em] text-slate-400">event stream</div>
      <div className="space-y-2 overflow-auto pr-1 text-xs">
